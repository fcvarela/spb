...
void main() {
  ...
  float heightu = texture2D(topoTexture, u).a*65536.0+texture2D(topoTexture, u).r*256.0-16384.0;
  float heightr = texture2D(topoTexture, r).a*65536.0+texture2D(topoTexture, r).r*256.0-16384.0;
  float heightc = texture2D(topoTexture, c).a*65536.0+texture2D(topoTexture, c).r*256.0-16384.0;
